...
var (
	...
	ErrUseLdap = errors.New("ldap")

	ErrInvalidLdapLogin = errors.New("ldap login error")
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	// var bufData map[string]interface{}
	/// json.Unmarshal(body, &bufData)

	// log.Printf(sring(body))
